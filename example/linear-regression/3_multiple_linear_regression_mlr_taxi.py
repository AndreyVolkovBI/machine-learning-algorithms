...
# y = b0 + b1*x1 + b2*x2 + b3*x3 + ... + bn*xn
y_output0 = regressor.intercept_ + regressor.coef_[0] * X_test[0][0] + regressor.coef_[1] * X_test[0][1] + \
            regressor.coef_[2] * X_test[0][2] + regressor.coef_[3] * X_test[0][3]

y_output1 = regressor.intercept_ + regressor.coef_[0] * X_test[1][0] + regressor.coef_[1] * X_test[1][1] + \
            regressor.coef_[2] * X_test[1][2] + regressor.coef_[3] * X_test[1][3]
